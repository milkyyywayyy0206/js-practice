...
console.log('addition of my 2 favorite number: ' + (firstFavNum + secondFavNum));
// 4. Subtract (firstFavNum & secondFavNumber).
console.log('subtraction of my 2 favorite number: ' + (firstFavNum - secondFavNum));
// 5. Multiply (firstFavNum & secondFavNumber).
console.log('multiplication of my 2 favorite number: ' + (firstFavNum * secondFavNum));
// 6. Divided (firstFavNum & secondFavNumber).
console.log('division of my 2 favorite number: ' + (firstFavNum / secondFavNum));
// 7. Check (firstFavNum Mod secondFavNumber).
console.log('modulus of my 2 favorite number: ' + (firstFavNum % secondFavNum));
// 8. Check the power of (firstFavNum) raise to secondFavNun.
console.log('exponentation of my 2 favorite number: ' + (firstFavNum ** secondFavNum));
